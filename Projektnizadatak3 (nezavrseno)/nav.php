<?php
	...
	<ul>
		...
		<li><a href="o-nama.php?menu=2">O nama</a></li>
		<li><a href="gotove-web-stranice.php?menu=3">Primjeri web stranica</a></li>
		<li><a href="kontakt.php?menu=4">Kontakt</a></li>';
	
	if (!isset($_SESSION['user']['valid']) || $_SESSION['user']['valid'] == 'false') {
		print '
		<li><a id="reg_prij" href="registracija.php?menu=5">Registracija</a></li>
